...
declare module 'csharp' {
    ...
    namespace Black_Rabbit.SimpleOutline {
        enum Mode
        { OutlineAll = 0, OutlineVisible = 1, OutlineHidden = 2, OutlineAndSilhouette = 3, SilhouetteOnly = 4 }
    }
    ...
    namespace Fungus {
        ...
        class Character extends UnityEngine.MonoBehaviour implements Fungus.ILocalizable, System.Collections.Generic.IComparer$1<Fungus.Character>
        {
        ...
        enum DisplayType
        { None = 0, Show = 1, Hide = 2, Replace = 3, MoveToFront = 4 }
        enum PositionOffset
        { None = 0, OffsetLeft = 1, OffsetRight = 2 }
        class Flowchart extends UnityEngine.MonoBehaviour implements Fungus.ISubstitutionHandler
        {
        ...
        interface ISubstitutionHandler
        {
        }
        class Command extends UnityEngine.MonoBehaviour implements Fungus.IVariableReference, Fungus.IStringLocationIdentifier
        {
        }
        interface IVariableReference extends Fungus.IStringLocationIdentifier
        {
        }
        interface IStringLocationIdentifier
        {
        }
        class Variable extends UnityEngine.MonoBehaviour
        {
        }
        class Label extends Fungus.Command implements Fungus.IVariableReference, Fungus.IStringLocationIdentifier
        {
        }
        class CommandInfoAttribute extends System.Attribute implements System.Runtime.InteropServices._Attribute
        {
        }
    }
}
