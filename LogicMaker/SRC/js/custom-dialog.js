...
CustomDialog.show = function(title, message, options) {
  ...
  dialogDiv.innerHTML =
      ...
      (options.showInput ? '<div><input id="customDialogInput" class="DialogInput"></div>' : '') +
      '<hr><br><div class="customDialogButtons">' +
      (options.showCancel ? '<button id="customDialogCancel">Cancel</button><span></span>': '') +
